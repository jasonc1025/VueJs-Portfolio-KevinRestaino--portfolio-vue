<template>
  ...
  <div class="mainNav">
    ...
    <router-link v-if="store.getters.tabModeGet==1" tag="a" to="/projects-react" @click.native="store.commit('tabModeSet','1')" ><linkActive>React</linkActive></router-link>
    ...
    <router-link v-if="store.getters.tabModeGet==2" tag="a" to="/projects-vue-js" @click.native="store.commit('tabModeSet','2')"><linkActive>Vue.js</linkActive></router-link>
    ...
    <router-link v-if="store.getters.tabModeGet==3" tag="a" to="/projects-node-js" @click.native="store.commit('tabModeSet','3')"><linkActive>Node.js</linkActive></router-link>
    ...
    <router-link v-if="store.getters.tabModeGet==4" tag="a" to="/projects-robotics" @click.native="store.commit('tabModeSet','4')"><linkActive>Robotics</linkActive></router-link>
    ...
    <router-link v-if="store.getters.tabModeGet==5" tag="a" to="/projects-industry-siemens" @click.native="store.commit('tabModeSet','5')"><linkActive>Industry:Siemens</linkActive></router-link>
